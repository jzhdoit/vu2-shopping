<template>
  <div class="category">
    ...
    <div class="list-box" v-if="list.length">
      ...
      <div class="right">
        <div v-for="val in list[activeIndex].children" :key="val.category_id" @click="$router.push(`/searchlist?search=${val.name}`)" class="cate-goods">
        <img :src="val.image.external_url" alt="">
        </div>
      </div>
    </div>
  </div>
