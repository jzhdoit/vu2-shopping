<template>
  <div class="pay">
    ...
    <div class="pay-list" v-if="order.goodsList">
      <div class="list">
        <div class="goods-item" @click="$router.push(`/prodetail/${item.goods_id}`)" v-for="item in order.goodsList" :key="item.goods_id">
          <div class="left">
    ...
    <div class="pay-way">
      ...
      <div class="pay-cell">
        <span><van-icon name="balance-o"></van-icon>余额支付（可用 ￥{{  }}元）</span>
        <!-- <span>请先选择配送地址</span> -->
